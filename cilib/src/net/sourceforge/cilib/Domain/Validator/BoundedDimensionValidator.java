/*
 * BoundedDimensionValidator.java
 * 
 ...
 * @author espeer
 */
public class BoundedDimensionValidator implements Validator {
    ...
    public void validate(DomainComponent component) {
        if (component.getDimension() == Compound.UNBOUNDED_DIMENSION) {
            throw new ValidationFailedException("Expected bounded dimension");
        }
    }
