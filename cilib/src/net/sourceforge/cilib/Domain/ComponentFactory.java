...
public class ComponentFactory {
    ...
    private ComponentFactory() {
        ...
        try {
            prefixes.put(Discrete.PREFIX, Discrete.class.getConstructor(stringParameter));
            prefixes.put(Continuous.PREFIX, Continuous.class.getConstructor(stringParameter));
     ...
     */
    public Component newComponent(String representation) {
        ...
        if (Character.isDigit(lastChar) || lastChar == 'N') {
            ...
            try {
                return (Component) constructor.newInstance(new Object[] { representation });
            }
            catch (Exception ex) {
