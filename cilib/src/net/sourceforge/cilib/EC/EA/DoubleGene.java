...
public class DoubleGene extends Gene {
    ...
    public void initialise(Domain domain) {
        Domain d = new Domain();
        d.setLowerBound(domain.getLowerBound() * Math.random());
        d.setUpperBound(domain.getUpperBound() * Math.random());
        ...
        geneValue = alpha1 * d.getUpperBound();
        geneValue += alpha2 * d.getLowerBound();
