...
public class Graph {
	...
	protected ArrayList<Edge> edgeSet;
	...
	public void addVertex(Vertex v) {
		for (ListIterator<Vertex> l = getVertices(); l.hasNext(); ) {
			Vertex currentVertex = l.next();
	 ...
	 */
	public ListIterator<Vertex> getVertices() {
	 ...
	 */
	public ListIterator<Vertex> getVertices(int index) {
	...
	public void printGraphSummary() {
		...
		{ 
			...
			ListIterator<Vertex> m = vertexSet.listIterator(0);
			while (m.hasNext()) {
				Vertex v = m.next();
				System.out.print("\t" + v.toString());
