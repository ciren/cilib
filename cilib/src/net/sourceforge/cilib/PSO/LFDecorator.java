...
public class LFDecorator extends ParticleDecorator implements Cloneable {
    ...
    public void initialise(OptimisationProblem problem, Initialiser initialiser) {
        previousPosition = new double[problem.getDimension()];
        previousVelocity = new double[problem.getDimension()];
        
        gradient = new double[problem.getDimension()];
        nextGradient = new double[problem.getDimension()];
        
        
        super.initialise(problem, initialiser);        
    }    
