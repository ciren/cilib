...
import net.sourceforge.cilib.Functions.Ackley;
...
public class FunctionMinimisationProblemTest extends TestCase {
    ...
    /** Test of getDimension method, of class za.ac.up.cs.ailib.Functions.FunctionMinimisationProblem. */
    public void testGetDimension() {
        assertEquals(function.getDimension(), problem.getDimension());
    }
    
    /** Test of getDomain method, of class za.ac.up.cs.ailib.Functions.FunctionMinimisationProblem. */
    public void testGetDomain() {
        for (int i = 0; i < problem.getDimension(); ++i) {
            assertSame(function.getDomain(), problem.getDomain(i));
        }
    }
    
    /** Test of getFitness method, of class za.ac.up.cs.ailib.Functions.FunctionMinimisationProblem. */
    public void testGetFitness() {
        assertEquals(- function.evaluate(x), problem.getFitness(x), 0.0);
    }
    ...
    /** Test of getError method, of class za.ac.up.cs.ailib.Functions.FunctionMinimisationProblem. */
    public void testGetError() {
        assertEquals(function.evaluate(x) - function.getMinimum(), problem.getError(x), 0.0);
    }
