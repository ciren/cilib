 ...
 * @author espeer
 */
public class MaxFitnessTest extends TestCase {

	public MaxFitnessTest(java.lang.String testName) {
        super(testName);
    }
    ...
    public void setUp() {
    	oneFitness = new MaximisationFitness(new Integer(1));
    	twoFitness = new MaximisationFitness(new Integer(2));
