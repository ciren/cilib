...
import net.cilib.ec.iterationstrategies.GeneticAlgorithmIterationStrategy;
...
import net.cilib.entity.initialisation.NullInitialisationStrategy;
 ...
 * appropriate {@linkplain net.cilib.algorithm.population.IterationStrategy}.
 */
public class EC<I extends Individual> extends SinglePopulationBasedAlgorithm<Individual> {
    ...
    /**
     * Get the {@linkplain net.cilib.algorithm.population.IterationStrategy} for the current
     * {@code EC}.
     * @return The current {@linkplain net.cilib.algorithm.population.IterationStrategy}.
     */
    ...
    /**
     * Set the current {@linkplain net.cilib.algorithm.population.IterationStrategy}.
