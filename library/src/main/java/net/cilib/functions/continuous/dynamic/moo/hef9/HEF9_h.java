 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.functions.continuous.dynamic.moo.hef9;
 ...
 *
 */
public class HEF9_h extends ContinuousFunction {
    ...
    public Double apply(int iteration, Vector x) {
        ...
        double g = ((HEF9_g) this.hef9_g).f(x);
        //evaluate the hef9_f1 function
        double f1 = this.hef9_f1.f(x);
