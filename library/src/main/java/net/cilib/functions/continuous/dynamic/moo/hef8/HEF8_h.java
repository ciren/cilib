 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.functions.continuous.dynamic.moo.hef8;
 ...
 *
 */
public class HEF8_h extends ContinuousFunction {
     ...
     * the problem.
     * @param hef8_f1 ContinuousFunction used for the f1 function.
     */
    ...
    public Double apply(int iteration, Vector x) {
        ...
        double g = ((HEF8_g) this.hef8_g).f(x);
        //evaluate the hef8_f1 function
        double f1 = this.hef8_f1.f(x);
