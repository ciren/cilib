...
/**
 * This function is the fk function of the adapted F6 problem defined in the
 ...
 *
 */
public class HEF6_fk extends ContinuousFunction {
    ...
    /**
     * Creates a new instance of HEF6_k.
     */
    public HEF6_fk() {
        this.K = 2;
        this.M = 3;
    ...
    public double apply(int iteration, Vector x) {
        ...
        double value = 1.0 + g;
        double val1 = Math.cos(0.5 * Math.abs(x.doubleValueOf(0)) * Math.PI) * Math.sin(0.5 * Math.abs(x.doubleValueOf(1)) * Math.PI);
        double sum = 0.0;
        int index = 0;
