 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.functions.continuous.dynamic.moo.hef6;
...
/**
 * This function is the f1 function of the adapted F6 problem defined in the
 ...
 */
public class HEF6_f1 extends ContinuousFunction {

    private static final long serialVersionUID = 5888250144779320506L;
    //members
    ...
    /**
     * Creates a new instance of HEF6_f1.
     */
    public HEF6_f1() {
        super();
        this.M = 3;
    ...
    public Double apply(int iteration, Vector x) {
        ...
        double value = 1.0 + g;
        double val1 = Math.cos(0.5 * Math.abs(x.doubleValueOf(0)) * Math.PI) * Math.cos(0.5 * Math.abs(x.doubleValueOf(1)) * Math.PI);
        double sum = 0.0;
        int index = 0;
