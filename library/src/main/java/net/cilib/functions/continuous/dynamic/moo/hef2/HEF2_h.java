 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.functions.continuous.dynamic.moo.hef2;
 ...
 *
 */
public class HEF2_h extends ContinuousFunction {
    ...
    public Double apply(int iteration, Vector x) {
        ...
        double g = ((HEF2_g) this.hef2_g).f(x);
        //evaluate the hef2_f1 function
        double f1 = this.hef2_f1.f(x);
