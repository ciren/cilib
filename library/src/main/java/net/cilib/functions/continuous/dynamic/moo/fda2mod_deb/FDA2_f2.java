 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.functions.continuous.dynamic.moo.fda2mod_deb;
...
/**
 * This function is the f2 function of the FDA2_mod problem defined in the following paper:
...
public class FDA2_f2 extends ContinuousFunction {
	 ...
	 * @return fda2_g_problem FunctionOptimisationProblem used for the g function.
     */
	 ...
	 * @return fda2_h_problem FunctionOptimisationProblem used for the h function.
     */
    ...
    public double apply(int iteration, Vector x) {
        Vector y = x;
        if (x.size() > 1)
            y = x.copyOfRange(1, 14);

        double g = this.fda2_g.f(y);
