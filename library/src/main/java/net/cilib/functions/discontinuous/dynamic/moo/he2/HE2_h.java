 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.functions.discontinuous.dynamic.moo.he2;
 ...
 *
 */
public class HE2_h extends ContinuousFunction {
    ...
    private int n_t;
    //functions
    private ContinuousFunction he2_g;
    private ContinuousFunction he2_f1;
    private FunctionOptimisationProblem he2_f1_problem;
    private FunctionOptimisationProblem he2_g_problem;
     ...
     */
    public void setHE2_f(FunctionOptimisationProblem problem) {
        this.he2_f1_problem = problem;
        this.he2_f1 = (ContinuousFunction) problem.getFunction();
    }

    /**
     * Returns the problem used to set the f1 function.
     * @return HE2_f1_problem FunctionOptimisationProblem used for the f1
     * function.
     */
    public FunctionOptimisationProblem getHE2_f_problem() {
        return this.he2_f1_problem;
    }

    /**
     * Sets the f1 function that is used in the HE1 problem without specifying
     * the problem.
     * @param HE2_f1 ContinuousFunction used for the f1 function.
     */
    public void setHE2_f(ContinuousFunction HE2_f1) {
        this.he2_f1 = HE2_f1;
    }

    /**
     * Returns the f1 function that is used in the HE1 problem.
     * @return HE2_f1 ContinuousFunction used for the f1 function.
     */
    public ContinuousFunction getHE2_f() {
        return this.he2_f1;
    }
    ...
    public Double apply(int iteration, Vector x) {
        ...
        double g = this.he2_g.f(z);
        //evaluate the fda1_f1 function
        double f1 = this.he2_f1.f(y);

        double sum = 1.0;
        double val = (double) f1 / (double) g;
        sum -= Math.pow(Math.sqrt(val), H);
        sum -= Math.pow(val, H) * Math.sin(10 * Math.PI * f1);
