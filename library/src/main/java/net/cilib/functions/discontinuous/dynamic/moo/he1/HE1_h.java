 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.functions.discontinuous.dynamic.moo.he1;
 ...
 *
 */
public class HE1_h extends ContinuousFunction {
    ...
    public Double apply(int iteration, Vector x) {
        ...
        double g = this.he1_g.f(z);
        //evaluate the fda1_f1 function
        double f1 = this.he1_f1.f(y);
