 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.entity.operators;
...
public interface Operator extends Cloneable {
    ...
    /**
     * Perform the operator operation given the current {@link net.cilib.entity.topologies.TopologyHolder}.
     *
     * @param holder The {@link net.cilib.entity.topologies.TopologyHolder} representing the required
     *               {@link net.cilib.entity.Topology} instances.
     */
