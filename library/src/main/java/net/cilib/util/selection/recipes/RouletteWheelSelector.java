...
import net.cilib.util.selection.arrangement.ProportionalArrangement;
import net.cilib.util.selection.arrangement.ReverseArrangement;
import net.cilib.util.selection.arrangement.SortedArrangement;
import net.cilib.util.selection.weighting.LinearWeighting;
import net.cilib.util.selection.weighting.Weighting;
