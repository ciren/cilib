...
public class DissipativeStep {
    ...
    public void execute(Particle particle) {
        ...
        //net.cilib.Type.Vector domain = (net.cilib.Type.Vector) pso.getOptimisationProblem().getDomain().getBuiltRepresentation();
        ...
        if (Rand.nextFloat() < velocityThreshold) {
            for (int i = 0; i < particle.getDimension(); ++i) {
                ...
                net.cilib.type.types.Real component = (net.cilib.type.types.Real) domain.get(i);
