...
import net.cilib.entity.operators.crossover.real.ArithmeticCrossoverStrategy;
import net.cilib.math.random.UniformDistribution;
import net.cilib.pso.PSO;
import net.cilib.pso.crossover.ParticleCrossoverStrategy;
import net.cilib.pso.crossover.parentupdate.AlwaysReplaceParentReplacementStrategy;
import net.cilib.pso.crossover.parentupdate.ParentReplacementStrategy;
import net.cilib.pso.crossover.pbestupdate.CurrentPositionOffspringPBestProvider;
import net.cilib.pso.crossover.velocityprovider.LovbjergOffspringVelocityProvider;
