...
import net.cilib.entity.AbstractEntity;
import net.cilib.entity.Entity;
import net.cilib.entity.initialisation.ConstantInitialisationStrategy;
import net.cilib.entity.initialisation.InitialisationStrategy;
import net.cilib.entity.initialisation.RandomInitialisationStrategy;
import net.cilib.entity.initialisation.StandardPBestPositionInitialisationStrategy;
import net.cilib.problem.solution.Fitness;
import net.cilib.pso.guideprovider.GuideProvider;
import net.cilib.pso.pbestupdate.PersonalBestUpdateStrategy;
import net.cilib.pso.pbestupdate.StandardPersonalBestUpdateStrategy;
import net.cilib.pso.positionprovider.MemoryNeighbourhoodBestUpdateStrategy;
import net.cilib.pso.positionprovider.NeighbourhoodBestUpdateStrategy;
import net.cilib.pso.positionprovider.PositionProvider;
import net.cilib.pso.velocityprovider.VelocityProvider;
