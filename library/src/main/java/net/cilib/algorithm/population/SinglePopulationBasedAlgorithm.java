...
import net.cilib.coevolution.cooperative.ParticipatingAlgorithm;
...
import net.cilib.entity.topologies.GBestNeighbourhood;
import net.cilib.entity.topologies.Neighbourhood;
import fj.data.List;
import net.cilib.util.functions.Entities;
