...
import net.cilib.entity.EntityIdFactory;
...
public abstract class AbstractAlgorithm implements Algorithm, Stoppable {
     ...
     * @param stoppingCondition A {@link net.cilib.stoppingcondition.StoppingCondition}
     *        to be added.
     */
    @Override
     ...
     * @param stoppingCondition The {@link net.cilib.stoppingcondition.StoppingCondition}
     *        to be removed.
     */
    @Override
