 ...
 * </p>
 * <ul>
 *   <li>{@linkplain net.cilib.algorithm.SingularAlgorithm Singular Algorithms}</li>
 *   <li>{@linkplain net.cilib.algorithm.population.SinglePopulationBasedAlgorithm Single Population Based Algorithms}</li>
 *   <li>{@linkplain net.cilib.algorithm.population.MultiPopulationBasedAlgorithm Multi Population Based Algorithms}</li>
 * </ul>
 *
 * <p>
