...
/**
 * Create a collection of {@linkplain net.cilib.entity.Entity entities}
 * by cloning the given prototype {@link net.cilib.entity.Entity}.
 *
...
public class ClonedPopulationInitialisationStrategy implements PopulationInitialisationStrategy {
    ...
    /**
     * Set the prototype {@linkplain net.cilib.entity.Entity entity} for the copy process.
