...
import net.cilib.math.StatsTests;
import net.cilib.problem.objective.Maximise;
import net.cilib.problem.objective.Minimise;
import net.cilib.problem.objective.Objective;
import net.cilib.problem.solution.OptimisationSolution;
import net.cilib.type.types.container.Vector;
import static net.cilib.util.functions.Fitnesses.getValue;
import static net.cilib.util.functions.Solutions.getFitness;
