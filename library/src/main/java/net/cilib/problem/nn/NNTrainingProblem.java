...
import net.cilib.io.transform.DataOperator;
import net.cilib.io.transform.DoNothingDataOperator;
import net.cilib.io.transform.PatternConversionOperator;
import net.cilib.io.transform.ShuffleOperator;
import net.cilib.nn.NeuralNetwork;
import net.cilib.problem.AbstractProblem;

/**
 * Abstract class represents an {@link net.cilib.problem.Problem} where the goal is to optimize
