 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.problem.mappingproblem;

import net.cilib.problem.AbstractProblem;
import net.cilib.problem.dataset.DataSetBuilder;
import net.cilib.problem.dataset.MatrixDataSetBuilder;
import net.cilib.problem.solution.Fitness;
import net.cilib.type.types.Type;
import net.cilib.type.types.container.Matrix;
