 ...
 * {@link net.cilib.functions.Function}.
 *
 */
public class FunctionOptimisationProblem extends AbstractProblem {
     ...
     * Remember to always set a {@link net.cilib.functions.Function} before attempting to apply
     * an {@linkplain net.cilib.algorithm.Algorithm algorithm} to this problem.
     *
     * @see #setFunction(net.cilib.functions.Function)
     */
