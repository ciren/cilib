 ...
 * an {@linkplain net.cilib.algorithm.Algorithm} has all
...
public interface Problem extends Cloneable {
     ...
     * {@link net.cilib.problem.solution.InferiorFitness} should be
     ...
     * problem.
     *
     * @return  a {@link net.cilib.type.DomainRegistry} object
