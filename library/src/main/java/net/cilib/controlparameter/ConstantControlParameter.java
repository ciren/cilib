...
/**
 * A {@linkplain net.cilib.controlparameter.ControlParameter control parameter}
...
public class ConstantControlParameter implements SettableControlParameter {
    ...
    /**
     * Create a new instance of {@linkplain net.cilib.controlparameter.ConstantControlParameter}
     * with the provided value as the value for the {@linkplain net.cilib.controlparameter.ControlParameter}.
