...
/**
 * A {@linkplain net.cilib.controlparameter.ControlParameter control parameter} is a
 * parameter that is used within most {@linkplain net.cilib.algorithm.Algorithm algorithm}
