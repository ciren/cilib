...
import net.cilib.controlparameter.LinearlyVaryingControlParameter;
import net.cilib.controlparameter.UpdateOnIterationControlParameter;
import net.cilib.entity.Entity;
import net.cilib.entity.visitor.ClosestEntityVisitor;
...
import net.cilib.pso.velocityprovider.ClampingVelocityProvider;
import net.cilib.pso.velocityprovider.GCVelocityProvider;
