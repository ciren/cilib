...
import net.cilib.algorithm.population.HasTopology;
...
import net.cilib.niching.iterationstrategies.NichePSO;
import net.cilib.niching.iterators.AllSwarmsIterator;
import net.cilib.niching.iterators.NicheIteration;
import net.cilib.niching.iterators.SingleNicheIteration;
import net.cilib.niching.iterators.SubswarmIterator;
...
import net.cilib.niching.merging.detection.MergeDetection;
import net.cilib.niching.merging.detection.RadiusOverlapMergeDetection;
import net.cilib.problem.boundaryconstraint.ReinitialisationBoundary;
