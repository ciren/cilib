...
import static net.cilib.niching.NichingFunctions.*;
import net.cilib.niching.NichingFunctions.NichingFunction;
import net.cilib.niching.NichingSwarms;
import static net.cilib.niching.NichingSwarms.*;
import net.cilib.problem.DeratingOptimisationProblem;
import net.cilib.problem.solution.OptimisationSolution;
import net.cilib.util.functions.Algorithms;
import net.cilib.util.functions.Solutions;
