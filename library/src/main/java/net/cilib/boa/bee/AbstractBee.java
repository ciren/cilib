 ...
 *  \___/_/_/_/_.___/
 */
package net.cilib.boa.bee;

import net.cilib.boa.positionupdatestrategies.BeePositionUpdateStrategy;
import net.cilib.boa.positionupdatestrategies.VisualPositionUpdateStategy;
