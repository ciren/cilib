...
/**
 * This class determines how opponents are selected from the opponent pool. 
 * A List of {@linkplain OpponentPoolSelectionStrategy}'s is maintained by
...
public abstract class OpponentSelectionStrategy implements Cloneable {
     ...
     */
    public abstract CompetitorList selectCompetitors(CompetitorList pool);
     ...
     */
    public CompetitorList setCompetitors(int currentPopulationID, List<PopulationBasedAlgorithm> populations) {
        CompetitorList competitorPool = new CompetitorList();
