...
public class QuantisationErrorMinimisationProblemTest {
    ...
    public void testCalculateFitness() {
        ...
        particle.put(Property.FITNESS, new MinimisationFitness(12.0));
        particle.put(Property.BEST_FITNESS, new MinimisationFitness(12.0));
        ...
        Fitness fitness = instance.getFitness(particle.getPosition());
