...
public class WFG6Test {
    ...
    public void testFitnessCalculation() throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader("library/src/test/resources/wfg/WFG6.data"));
        String line = "";
        while ((line = reader.readLine()) != null) {
            ...
            Vector expected_y = Problems.WFG6(x, k, M);
