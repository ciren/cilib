...
public class WFG5Test {
    ...
    public void testFitnessCalculation() throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader("library/src/test/resources/wfg/WFG5.data"));
        String line = "";
        while ((line = reader.readLine()) != null) {
            ...
            Vector expected_y = Problems.WFG5(x, k, M);
