...
import net.cilib.algorithm.ProgressEvent;
import net.cilib.algorithm.ProgressListener;
import net.cilib.math.random.generator.seeder.SeedSelectionStrategy;
import net.cilib.math.random.generator.seeder.Seeder;
...
public class Simulator {
     ...
     * measurement suite.
     * @see net.cilib.XMLObjectFactory
