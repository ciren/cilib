 ...
 * </p>
 *
 * See: <a href="http://www.net/projects/cilib/">Factory Demo</a> for XML samples.
 *
 */
public class XMLObjectFactory {
    ...
    private Class<?> getClass(Element xml) {
        ...
        try {
            return Class.forName("net.cilib." + className);
        } catch (ClassNotFoundException e) {
            System.out.println("Class not found: net.cilib." + className);
            e.printStackTrace();
        }
