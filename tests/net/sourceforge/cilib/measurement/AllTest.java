...
@SuiteClasses(
		value = {
			net.sourceforge.cilib.measurement.generic.AllTest.class,
			net.sourceforge.cilib.measurement.multiple.AllTest.class,
			net.sourceforge.cilib.measurement.single.AllTest.class
		}
	)
