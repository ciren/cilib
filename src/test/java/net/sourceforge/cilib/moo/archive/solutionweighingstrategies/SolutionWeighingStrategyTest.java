...
public class SolutionWeighingStrategyTest {

    private static Collection<OptimisationSolution> solutions;
    ...
    public void testAntiClusteringWeighingStrategy() {
        AntiClusterWeighingStrategy antiClusterWeighingStrategy =
                new AntiClusterWeighingStrategy();
        Collection<Pair<Double, OptimisationSolution>> weighedSolutions =
                antiClusterWeighingStrategy.weigh(solutions);
