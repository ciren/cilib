...
public class ClusteringFitnessFunctionTest {
    ...
    public static void intialise() {
        ...
        Vector.Builder centroidsB = Vector.newBuilder();
        centroidsB.add(Int.valueOf(1));
        centroidsB.add(Int.valueOf(1));
        centroidsB.add(Int.valueOf(33));
        centroidsB.add(Int.valueOf(8));
        centroidsB.add(Int.valueOf(20));
        centroidsB.add(Int.valueOf(19));
        centroidsB.add(Int.valueOf(11));
        centroidsB.add(Int.valueOf(22));
        centroidsB.add(Int.valueOf(30));
        centroidsB.add(Int.valueOf(27));
        centroidsB.add(Int.valueOf(19));
        centroidsB.add(Int.valueOf(40));
        centroidsB.add(Int.valueOf(5));
        centroidsB.add(Int.valueOf(50));
        
        centroids = centroidsB.build();
    }
