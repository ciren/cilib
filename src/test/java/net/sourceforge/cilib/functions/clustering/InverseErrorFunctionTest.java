 ...
 */
public class InverseErrorFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new InverseErrorFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(4.50384456208303, ClusteringFunctionTests.EPSILON));
    }
}
