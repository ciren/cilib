...
public class DaviesBouldinIndexTest {
    ...
    public void testApply() {
        ClusteringFunction<Double> function = new DaviesBouldinIndex();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(0.276567309747911, ClusteringFunctionTests.EPSILON));
    }
}
