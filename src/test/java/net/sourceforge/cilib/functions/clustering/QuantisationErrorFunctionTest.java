 ...
 */
public class QuantisationErrorFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new QuantisationErrorFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(1.27823623040265, ClusteringFunctionTests.EPSILON));
    }
}
