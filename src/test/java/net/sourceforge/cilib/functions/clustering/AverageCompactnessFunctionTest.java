 ...
 */
public class AverageCompactnessFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new AverageCompactnessFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(1.30710678118655, ClusteringFunctionTests.EPSILON));
    }
}
