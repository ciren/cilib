...
public class ParametricClusteringFunctionTest {
    ...
    public void testApply() {
        ClusteringFunction function = new ParametricClusteringFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, null, 0.0, 100.0), closeTo(45.7803300858899, ClusteringFunctionTests.EPSILON));
    }
}
