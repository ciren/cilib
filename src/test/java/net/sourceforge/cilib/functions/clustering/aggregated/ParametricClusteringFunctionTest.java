 ...
 */
public class ParametricClusteringFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new ParametricClusteringFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 100.0), closeTo(45.7803300858899, ClusteringFunctionTests.EPSILON));
    }
}
