 ...
 */
public class KHarmonicMeansFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new KHarmonicMeansFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(36.4437904552082, ClusteringFunctionTests.EPSILON));
    }
}
