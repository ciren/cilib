 ...
 */
public class TotalErrorFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new TotalErrorFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(-55.2132034355964, ClusteringFunctionTests.EPSILON));
    }
}
