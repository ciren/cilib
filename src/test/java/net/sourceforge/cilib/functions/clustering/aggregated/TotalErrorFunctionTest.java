...
public class TotalErrorFunctionTest {
    ...
    public void testApply() {
        ClusteringFunction function = new TotalErrorFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, null, 0.0, 0.0), closeTo(-55.2132034355964, ClusteringFunctionTests.EPSILON));
    }
}
