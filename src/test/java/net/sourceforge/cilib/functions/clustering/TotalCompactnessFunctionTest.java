 ...
 */
public class TotalCompactnessFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new TotalCompactnessFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(13.07106781186550, ClusteringFunctionTests.EPSILON));
    }
}
