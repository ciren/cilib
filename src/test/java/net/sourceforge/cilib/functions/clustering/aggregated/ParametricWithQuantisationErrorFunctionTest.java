 ...
 */
public class ParametricWithQuantisationErrorFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new ParametricWithQuantisationErrorFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 100.0), closeTo(27.979492543695, ClusteringFunctionTests.EPSILON));
    }
}
