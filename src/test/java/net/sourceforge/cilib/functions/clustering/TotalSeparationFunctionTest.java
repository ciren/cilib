 ...
 */
public class TotalSeparationFunctionTest {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new TotalSeparationFunction();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(68.2842712474619, ClusteringFunctionTests.EPSILON));
    }
}
