...
public class TuriIndexTest {
    ...
    public void testApply() {
        ClusteringFunction<Double> function = new TuriIndex();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterCentroidStrategy(), null, 0.0, 0.0), closeTo(0.130710678118655, ClusteringFunctionTests.EPSILON));
    }
}
