 ...
 */
public class VeenmanReindersBackerIndexTest {
    ...
    public void testApply() {
        ...
        assertThat(function.apply(clusters, patterns, distanceMeasure, dataSetMean, 0.0, 0.0), closeTo(0.633333333333333, ClusteringFunctionTests.EPSILON));
    }
}
