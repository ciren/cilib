...
public class DunnIndex33Test {
    ...
    public void testApply() {
        ClusteringFunction function = new DunnIndex33();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, null, 0.0, 0.0), closeTo(4.70581657724851, ClusteringFunctionTests.EPSILON));
    }
}
