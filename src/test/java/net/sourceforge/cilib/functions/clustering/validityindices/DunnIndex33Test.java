 ...
 */
public class DunnIndex33Test {

    @Test
    public void testApply() {
        ClusteringFunction<Double> function = new DunnIndex33();
        ...
        assertThat(function.apply(clusters, dataTable, distanceMeasure, new ClusterMeanStrategy(), null, 0.0, 0.0), closeTo(4.70581657724851, ClusteringFunctionTests.EPSILON));
    }
}
