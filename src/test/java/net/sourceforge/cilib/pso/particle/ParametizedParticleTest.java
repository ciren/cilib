 ...
 * @author Kristina
 */
public class ParametizedParticleTest {
    
    public ParametizedParticleTest() {
    }
    ...
    public void testGetBestFitness() {
        ...
        ParametizedParticle instance = new ParametizedParticle();
    ...
    public void testGetNeighbourhoodBest() {
        ...
        ParametizedParticle neighbourhoodBest = new ParametizedParticle();
        neighbourhoodBest.setCandidateSolution(vector);
        instance.setNeighbourhoodBest(neighbourhoodBest);
        
        ParametizedParticle result = instance.getNeighbourhoodBest();
    ...
    public void testInitialise() {
        ...
        instance = new ParametizedParticle();
