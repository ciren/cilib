 ...
 * @author filipe
 */
public class ALIterationStrategy implements IterationStrategy<PSO>, HeterogeneousIterationStrategy {
    ...
    private class ParticleStats {
        Map<ParticleBehavior, Double> selectionRatio;
        Map<ParticleBehavior, Double> selectionRatioPrime;
        Map<ParticleBehavior, Double> progress;
        Map<ParticleBehavior, Double> progressPrime;
        Map<ParticleBehavior, Double> reward;
    }
    ...
    public ALIterationStrategy(ALIterationStrategy copy) {
    ...
    @Override
    public ALIterationStrategy getClone() {
        return new ALIterationStrategy(this);
    }
