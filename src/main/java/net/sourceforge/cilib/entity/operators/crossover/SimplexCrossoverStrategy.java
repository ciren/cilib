 ...
 * vol.1, no., pp.974-979, 12-17 May 2002
 * doi: 10.1109/CEC.2002.1007057
 * URL: http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=1007057&isnumber=21693
 * </p>
 * <p>
...
public class SimplexCrossoverStrategy extends CrossoverStrategy {
    ...
    public SimplexCrossoverStrategy() {
        ...
        this.epsilon = new ConstantControlParameter(0.1);
    ...
    public List<Entity> crossover(List<Entity> parentCollection) {
        ...
        if(useDefaultEpsilon) {
            epsilon = new ConstantControlParameter(n + 1);
        }
