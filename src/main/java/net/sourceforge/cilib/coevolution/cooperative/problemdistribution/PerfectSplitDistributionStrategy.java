...
/**
 * This {@linkplain ProblemDistributionStrategy} performs a split by assining a
 * sequencial portion of the same length to each participating {@linkplain PopulationBasedAlgorithm}.
...
public class PerfectSplitDistributionStrategy implements ProblemDistributionStrategy {
    ...
    /**
     * Splits up the given {@link OptimisationProblem} into sub-problems, where each sub problem contains a sequencial, uniform length, portion of the problem verctor, and assigns all the sub-problems to the sub population {@link Algorithm}s.
