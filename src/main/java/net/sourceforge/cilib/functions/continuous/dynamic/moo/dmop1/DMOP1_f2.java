...
/**
 * This function is the f2 function of the DMOP1 problem defined on page 119 in the following article:
...
public class DMOP1_f2 implements ContinuousFunction {
	...
	FunctionMinimisationProblem dmop1_g_problem;
	FunctionMinimisationProblem dmop1_h_problem;
	 ...
	 */
	public void setDMOP1_g(FunctionMinimisationProblem problem) {
	 ...
	 * @return dmop1_g_problem FunctionMinimisationProblem used for the g function.
	 */
	public FunctionMinimisationProblem getDMOP1_g_problem() {
		return this.dmop1_g_problem;
	}
		
	/**
	 * Sets the g function that is used in the DMOP1 problem without specifying the problem.
	 ...
	 */
	public void setDMOP1_h(FunctionMinimisationProblem problem) {
	 ...
	 * @return dmop1_h_problem FunctionMinimisationProblem used for the h function.
	 */
	public FunctionMinimisationProblem getDMOP1_h_problem() {
		return this.dmop1_h_problem;
	}
	
	/**
	 * Sets the h function that is used in the DMOP1 problem without specifying the problem.
