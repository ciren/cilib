...
/**
 * This function is the f1 function of the FDA5 problem defined on page 430 in the following article:
...
public class FDA5_f1 implements ContinuousFunction {

	private static final long serialVersionUID = -5953711368749241354L;
	
	//members
	FunctionMinimisationProblem fda5_g_problem;
	...
	/**
	 * Creates a new instance of FDA5_f1.
	 */
	public FDA5_f1() {
		super();
		this.M = 3;
	 ...
	 * @param tau The iteration number.
	 */
	 ...
	 * @return tau The iteration number.
	 */
	public int getTau() {
		return this.tau;
	}
	 ...
	 */
	public void setFDA5_g(FunctionMinimisationProblem problem) {
	 ...
	 * @return fda5_g_problem FunctionMinimisationProblem used for the g function.
	 */
	public FunctionMinimisationProblem getFDA5_g_problem() {
		return this.fda5_g_problem;
	}
	
	/**
	 * Sets the g function that is used in the FDA5 problem without specifying the problem.
