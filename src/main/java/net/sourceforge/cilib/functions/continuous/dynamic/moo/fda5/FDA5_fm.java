...
/**
 * This function is the fm function of the FDA5 problem defined on page 430 in the following article:
...
public class FDA5_fm implements ContinuousFunction {
	...
	/**
	 * Creates a new instance of FDA5_fm.
	 */
	public FDA5_fm() {
		super();
		this.M = 3;
	...
	public Double apply(int iteration, Vector x) {
		...
		double y_1 = Math.pow(x.doubleValueOf(0), F);
