...
/**
 *  This function is the f2 function of the DIMP1 problem defined in the following paper:
...
public class DIMP1_f2 implements ContinuousFunction {
    ...
    FunctionMinimisationProblem dimp1_g_problem;
    FunctionMinimisationProblem dimp1_h_problem;
     ...
     */
    public void setDIMP1_h(FunctionMinimisationProblem problem) {
	 ...
	 * @return dimp1_h_problem FunctionMinimisationProblem used for the h function.
     */
    public FunctionMinimisationProblem getDIMP1_h_problem() {
        return this.dimp1_h_problem;
    }

    /**
     * Sets the h function that is used in the DIMP1 problem without specifying the problem.
    ...
    /**
     * Sets the f1 hunction that is used in the DIMP1 problem without specifying the problem.
	 * @param dimp1_h ContinuousFunction used for the h function.
     */
