...
/**
 * This function is the h function of the DIMP2 problem defined in the following paper:
...
public class DIMP2_h implements ContinuousFunction {
    ...
    private FunctionMinimisationProblem dimp2_f1_problem;
    private FunctionMinimisationProblem dimp2_g_problem;
     ...
     */
    public void setDIMP2_f(FunctionMinimisationProblem problem) {
	 ...
	 * @return dimp2_f1_problem FunctionMinimisationProblem used for the f1 function.
     */
    public FunctionMinimisationProblem getDIMP2_f_problem() {
        return this.dimp2_f1_problem;
    }

    /**
     * Sets the f1 function that is used in the DIMP2 problem without specifying the problem.
	 * @param dimp2_f ContinuousFunction used for the f1 function.
     */
