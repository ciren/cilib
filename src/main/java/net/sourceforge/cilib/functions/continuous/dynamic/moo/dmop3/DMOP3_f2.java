...
/**
 * This function is the f2 function of the DMOP3 problem defined on page 119 in the following article:
...
public class DMOP3_f2 implements ContinuousFunction{
	...
	FunctionMinimisationProblem dmop3_g_problem;
	FunctionMinimisationProblem dmop3_h_problem;
	 ...
	 */
	public void setDMOP3_g(FunctionMinimisationProblem problem) {
	 ...
	 * @return dmop3_g_problem FunctionMinimisationProblem used for the g function.
	 */
	public FunctionMinimisationProblem getDMOP3_g_problem() {
		return this.dmop3_g_problem;
	}
		
	/**
	 * Sets the g function that is used in the DMOP3 problem without specifying the problem.
	 ...
	 */
	public void setDMOP3_h(FunctionMinimisationProblem problem) {
	 ...
	 * @return dmop3_h_problem FunctionMinimisationProblem used for the h function.
	 */
	public FunctionMinimisationProblem getDMOP3_h_problem() {
