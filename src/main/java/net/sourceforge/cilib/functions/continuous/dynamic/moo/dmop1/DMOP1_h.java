...
public class DMOP1_h implements ContinuousFunction {
	...
	private FunctionMinimisationProblem dmop1_f1_problem;
	private FunctionMinimisationProblem dmop1_g_problem;
	 ...
	 */
	public void setDMOP1_f(FunctionMinimisationProblem problem) {
	 ...
	 * @return dmop1_f1_problem FunctionMinimisationProblem used for the f1 function.
	 */
	public FunctionMinimisationProblem getDMOP1_f_problem() {
		return this.dmop1_f1_problem;
	}
	
	/**
	 * Sets the f1 function that is used in the DMOP1 problem without specifying the problem.
