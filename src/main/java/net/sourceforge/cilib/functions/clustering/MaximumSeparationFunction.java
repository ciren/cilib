...
/**
 * Calculate the maximum separation between all the given clusters. In other words, the distance between the centers
 * of the two clusters that are furthest apart.
 *
