...
public class HE2_h implements ContinuousFunction {
	...
	private FunctionMinimisationProblem he2_f1_problem;
	private FunctionMinimisationProblem he2_g_problem;
	 ...
	 */
	public void setHE2_f(FunctionMinimisationProblem problem) {
	 ...
	 * @return HE2_f1_problem FunctionMinimisationProblem used for the f1 function.
	 */
	public FunctionMinimisationProblem getHE2_f_problem() {
	...
	public Double apply(int iteration, Vector x) {
		...
		double g = this.he2_g.apply(z);
                //evaluate the fda1_f1 function
		double f1 = this.he2_f1.apply(y);
