...
public class NicheGA
    ...
    private Vector<EA> niches = new Vector<EA>();
    ...
    public void mergeNiches() {
        Vector<Population> populationVector = new Vector<Population>();
    ...
    public double[][] getNicheSolution() {
        if (!niches.isEmpty()) {
            double[][] nicheSolution =
                new double[niches
                    .size()][DomainParser.getInstance().getDimension()];
            ...
            double[][] nicheSolution =
                new double[1][DomainParser.getInstance().getDimension()];
    ...
    private Vector identifyNiches(Population p) {
        ...
        Vector<Individual> individuals = new Vector<Individual>(p.getIndividuals().values());
