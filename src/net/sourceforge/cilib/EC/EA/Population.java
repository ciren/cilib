...
public class Population {
    private HashMap<Long, Individual> individuals = new HashMap<Long, Individual>();
    private int size = 20;
    @SuppressWarnings("unused")	private long lastIndex = 0;
    ...
    public HashMap<Long, Individual> getIndividuals() {
        return individuals;
    }
    ...
    public long getLastIndex() {
        ...
        Set<Long> keySet = individuals.keySet();
        Vector<Long> list = new Vector<Long>(keySet);
