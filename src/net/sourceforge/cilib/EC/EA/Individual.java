...
public class Individual implements Comparable<Individual> {
    ...
    protected Fitness fitness = InferiorFitness.instance();
    protected Fitness bestFitness = InferiorFitness.instance();
    ...
    public void initialise(int component, DomainComponent domain) {
    ...
    public int compareTo(Individual o2) {
        ...
        return getBestFitness().compareTo(individual2.getBestFitness());
        
        /*
        if (getBestFitness().compareTo(individual2.getBestFitness()) < 0) {
            return 1;
        }
        else if (getBestFitness().compareTo(individual2.getBestFitness()) > 0) {
            return -1;
        }
        else {
            return 0;
