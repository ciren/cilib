 ...
 *
 */
public class OldBitVector extends OldVector implements Cloneable {
	
	public Object clone() throws CloneNotSupportedException {
		OldBitVector clone = (OldBitVector) super.clone();
		clone.bits = (BitSet) bits.clone();
		return clone;
	}
	
	public boolean equals(Object other) {
		if (other instanceof OldBitVector) {
				return bits.equals(((OldBitVector) other).bits);
		}
		else {
			return false;
		}
	...
	public OldBitVector(int dimension) {
		bits = new BitSet();
	...
	public OldType get(int index) {
		return new OldBit(getBit(index));
	}
	...
	public void set(int index, OldType value) {
		...
		if (value instanceof OldNumeric) {
			setBit(index, ((OldNumeric) value).getBit());
		}
		else if (value instanceof OldVector) {
	...
	public void insert(int index, OldType value) {
		...
		if (value instanceof OldNumeric) {
			boolean tmp = ((OldNumeric) value).getBit();
