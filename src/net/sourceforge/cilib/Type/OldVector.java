...
public abstract class OldVector extends OldType  implements Cloneable {
	...
	public boolean equals(Object other) {
		if (other instanceof OldVector) {
			OldVector tmp = (OldVector) other;
	...
	public abstract OldType get(int index);
	public abstract void set(int index, OldType value);
	
	public abstract void insert(int index, OldType value);	
	public abstract void remove(int index);
	
	public  void append(OldType value) {
		insert(getDimension(), value);
	}
	public  void prepend(OldType value) {
		insert(0, value);
	}
