...
public abstract class Function {
    ...
    public Function() {
        ...
        constraint.add(new TypeValidator(net.sourceforge.cilib.Domain.Vector.class));
    }
    
    public int getDimension() {
        //return domain.getDimension();
    	//return 0;
    	//return Domain.getInstance().getDimension();
    	return DomainParser.getInstance().getDimension();
    }
    ...
    public String getDomain() {
        //return Domain.getInstance().getRepresentation();
    	return DomainParser.getInstance().getExpandedRepresentation();
    }
    ...
    /*    DomainComponent tmp = ComponentFactory.instance().newComponent(representation);
    	...
    	// TODO: Add validation for the string
    	domain.setRepresentation(representation);
    	
    	Vector t = (Vector) domain.getBuiltRepresentation();
    	
    	for (int i = 0; i < t.getDimension(); i++) {
    		System.out.println("i: " + i + " " + t.get(i));
    	}*/
    	//System.out.println("Setting domain: " + representation);
