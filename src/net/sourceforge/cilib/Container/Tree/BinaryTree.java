...
public class BinaryTree implements Tree {
	 ...
	 */
	public BinaryTree(Object nodeValue) {
	 ...
	 */
	public void add(BinaryTree b, int position) {
	 ...
	 */
	public void addLeftSubtree(BinaryTree b) {
		add(b, LEFT);
	}
	 ...
	 */
	public void addRightSubtree(BinaryTree b) {
		add(b, RIGHT);
	}
	 ...
	 */
	public Tree removeSubtree(int position) {
	 ...
	 */
	public Tree removeRightSubtree() {
	...
	public void accept(Visitor v) {
		...
		depthFirstTraversal((PrePostVisitor) v);
