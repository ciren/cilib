...
public class Matrix<T> {
	private ArrayList< ArrayList<T> > data; // This is the ArrayList of the 1st dimension
	private int rows;
	private int cols;
	 ...
	 */
	public T getItemAt(int row, int col) {
		if ((row >= rows || col >= cols) && (row >= 0 || col >= 0)) {
