...
public class PSO extends Algorithm implements OptimisationAlgorithm, ParticipatingAlgorithm {
    ...
    public PSO() {
        ...
        initialiser = new RandomInitialiserOld();
    ...
    public OptimisationSolution getBestSolution() {
    	...
    	try {
    		solution = new OptimisationSolution(problem, getBestParticle().getBestPosition().clone());
    	}
    ...
    protected Particle getBestParticle() {
        if (bestParticle == null) {
            Iterator<Particle> i = topology.particles();
            bestParticle =  i.next();
    ...
    public double getSwarmDiameter() {
    	...
    	Vector center = getBestParticle().getPosition();
    	DistanceMeasure distance = new EuclideanDistanceMeasure();
        double diameter = 0;
        int count = 0;
        for (Iterator<Particle> i = topology.particles(); i.hasNext(); ++count) {
