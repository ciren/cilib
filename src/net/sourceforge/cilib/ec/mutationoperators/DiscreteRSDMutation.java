/*
 * DiscreteRandomSampleDistroMutation.java
 * 
...
import net.sourceforge.cilib.math.random.DiscreteRandomNumber;
...
public abstract class DiscreteRSDMutation<E extends Entity> extends RandomSampleDistributionMutation<E> {
    ...
    public DiscreteRSDMutation() {
        randomSample = new DiscreteRandomNumber();
    }

    public void setRandomSample(DiscreteRandomNumber randomSample) {
