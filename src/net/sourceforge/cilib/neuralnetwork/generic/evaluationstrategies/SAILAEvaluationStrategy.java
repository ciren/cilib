 ...
 * 
 */
public class SAILAEvaluationStrategy extends EvaluationStrategy {
	 ...
	 * @param factory
	 */
	public SAILAEvaluationStrategy(NeuralNetworkTopology topology_,
	...
	public void learningEpoch(){
		...
		if(terminate){
			...
			System.out.println("SAILA update...");
